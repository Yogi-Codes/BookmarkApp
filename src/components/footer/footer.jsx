...
<nav className="navbar navbar-dark bg-dark fixed-bottom " style={{border: "1px solid black", position:"relative" }}>
  <div className="container-fluid">
    ...
    <div className="offcanvas offcanvas-end text-bg-dark" tabIndex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div className="offcanvas-body" style={{backgroundImage: `url("https://cdn.pixabay.com/photo/2020/01/09/14/17/abstract-4752872_960_720.jpg")`}}>
  ...
  <br />
  <button type="submit" className="btn btn-lg  btn-warning "  onClick={addT}><b>+</b></button>
</form>
      </div>
    </div>
  </div>
